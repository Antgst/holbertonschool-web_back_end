...
---
×
Students who are done with "0. The basics of async"
×
...
- [`1-concurrent_coroutines.py`](https://github.com/Antgst/holbertonschool-web_back_end/blob/main/python_async_function/1-concurrent_coroutines.py)
...
Import
wait_random
from the previous python file that you've written and write an async routine called
wait_n
...
wait_random
n
times with the specified
max_delay
.
wait_n
should return the list of all the delays (float values). The list of the delays should be in ascending order without using
sort()
...
---
×
Students who are done with "1. Let's execute multiple coroutines at the same time with async"
×
Recommended Sandboxes
Loading...
```
...
- [`2-measure_runtime.py`](https://github.com/Antgst/holbertonschool-web_back_end/blob/main/python_async_function/2-measure_runtime.py)
...
---
×
Students who are done with "2. Measure the runtime"
×
Recommended Sandboxes
Loading...
```
...
- [`3-tasks.py`](https://github.com/Antgst/holbertonschool-web_back_end/blob/main/python_async_function/3-tasks.py)
...
---
×
Students who are done with "3. Tasks"
×
Recommended Sandboxes
Loading...
```
...
- [`4-tasks.py`](https://github.com/Antgst/holbertonschool-web_back_end/blob/main/python_async_function/4-tasks.py)
...
---
×
Students who are done with "4. Tasks"
×
Recommended Sandboxes
Loading...
```
